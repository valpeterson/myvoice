...
public class SettingsActivity extends PreferenceActivity {
     ...
     * Using code found at http://stackoverflow.com/questions/19973034/isvalidfragment-android-api-19
     * Submitter of the idea also had a getValidResId that was called instead of passing static
     * R.xml.pref_headers to tryObtainValidFragmentList, which checked if user was authorized.
     * I removed that since I don't think it's necessary.
     */
    @Override
    protected boolean isValidFragment(String fragmentName) {
        List<Header> headers = new ArrayList<>();
        /** fill fragments list */
        tryObtainValidFragmentList(R.xml.pref_headers, headers);
        /** check  id valid */
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            // guidelines.
            bindPreferenceSummaryToValue(findPreference("example_text"));
            bindPreferenceSummaryToValue(findPreference("default_activity_list"));
        }
    }
